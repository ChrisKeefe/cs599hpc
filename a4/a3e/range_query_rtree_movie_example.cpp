...
int main(int argc, char **argv) {
  ...
  //Import sample movie database data
  struct dataStruct * data=(struct dataStruct *)malloc(sizeof(struct dataStruct)*N);
  populateSampleData(data);


  //Construct tree:
  //R-tree parameters:
  //DATATYPE-- referenced data, e.g., integer (object 1, 2, 3, etc.)
  //ELEMTYPE-- data type of the coordinates (e.g., movie rating)
  //NUMDIMS-- data dimensionality (here, 2) 
  //ELEMTYPEREAL-- data type used in volume calculations, use double to minimize FP error
  ...
  //Search tree:
  //Range of time:1275375600-1309503600
  //Range in rating: 7.1-9.1
  ...
  printf("\nResult of Range Query\nDate range: June 1, 2010 - July 1, 2011\nDate range since Epoch: 1275375600 - 1309503600\nRatings range: 7.1-9.1\nNumber of movies: %d\n\n", nhits);
